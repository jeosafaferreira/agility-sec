 ...
 * @author jferreira
 */
public class CurSelec extends javax.swing.JDialog {
    ...
    private void listCourses() {
        try {
            rs = con.prepareStatement("SELECT id, name FROM courses WHERE status=1 ORDER BY name;").executeQuery();
            while (rs.next()) {
                nameId.put(rs.getString("name"), rs.getString("id"));
                cboCur.addItem(rs.getString("name"));
            }
            cboCur.setSelectedIndex(-1);
        } catch (SQLException ex) {
            AgilitySec.showError(this, "#1112", ex);
        }
    }
    ...
    private boolean check() {
        ...
        if (cboCur.getSelectedIndex() != -1) {
            this.course_id = nameId.get(cboCur.getSelectedItem().toString());
            r = true;
        } else {
    ...
    public String getId() {
        return nameId.get(cboCur.getSelectedItem().toString());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CurSelec.class
